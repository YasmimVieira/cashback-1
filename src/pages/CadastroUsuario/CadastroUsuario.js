        ...
        <Col xl="6" id="col-cadastro">
          ...
          <AvForm>
            ...
            <AvField
              ...
              onChange={this.handleChange}
              validate={{
                required: { value: true, errorMessage: "CPF inválido" },
                pattern: {
            ...
            <AvField
              ...
              onChange={this.handleChange}
              validate={{
                required: { value: true, errorMessage: "Email inválido" },
            ...
            <AvField
              ...
              validate={{
                required: {
                  value: true,
                  errorMessage: "Necessário no mínimo 8 caracteres",
                },
                minLength: {
                  value: 8,
                  errorMessage: "Necessário no mínimo 8 caracteres",
            ...
            <AvField
              ...
              validate={{
                required: {
                  value: true,
                  errorMessage: "Mesma senha do campo anterior",
                },
                minLength: {
                  value: 8,
                  errorMessage: "Mesma senha do campo anterior",
...
const mapDispatchToProps = (dispatch) =>
  bindActionCreators(actionUsuarios, dispatch);
